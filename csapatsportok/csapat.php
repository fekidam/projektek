...
<h1>Csapat felvetele</h1>
<div id="be">
<form method="POST" action="csapatbeszur.php" accept-charset="utf-8">
    ...
    <label class="formlabel">Gyozelem:</label><input class="forminput" type="number" name="gyozelem"><br>
    <label class="formlabel">Vereseg:</label><input class="forminput" type="number" name="vereseg"><br>
    <label class="formlabel">Dontetlen:</label><input class="forminput" type="number" name="dontetlen"><br>
	<label class="formlabel">Divizio:</label><input class="forminput" type="number" name="divizio"><br>
...
<tr>
    ...
    $csapat=csapat_leker();
    while($egysor =mysqli_fetch_assoc($csapat)){
    echo '<form action="csapatszerkesztes.php" method="POST">';
    echo '<tr>';
    echo '<td>'.$egysor["csapatid"].'</td>';
    echo '<td>'.$egysor["nev"].'</td>';
    echo '<td>'.$egysor["gyozelem"].'</td>';
    echo '<td>'.$egysor["vereseg"].'</td>';
    echo '<td>'.$egysor["dontetlen"].'</td>';
	echo '<td>'.$egysor["divizio"].'</td>';
