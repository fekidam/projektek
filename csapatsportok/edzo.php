...
<h1>Edzo felvetele</h1>
<div id="be">
<form method="POST" action="edzobeszur.php" accept-charset="utf-8">
    ...
    <label class="formlabel">Eletkor:</label><input class="forminput" type="number" name="eletkor"><br>
    <label class="formlabel">Egyesulet:</label><input class="forminput" type="text"name="egyesulet"><br>
	<label class="formlabel">Szarmazas:</label><input class="forminput" type="text"name="szarmazas"><br>
    <input class="forminput" type="submit"  value="Feltolt">
</div>
</form>
<br>
<table id="eredmeny">
    <tr>
        ...
        $edzo=edzo_leker();
        while($egysor =mysqli_fetch_assoc($edzo)){
            echo '<form action="edzoszerkesztes.php" method="POST">';
            echo '<tr>';
            echo '<td>'.$egysor["edzoid"].'</td>';
            echo '<td>'.$egysor["nev"].'</td>';
            echo '<td>'.$egysor["eletkor"].'</td>';
            echo '<td>'.$egysor["egyesulet"].'</td>';
