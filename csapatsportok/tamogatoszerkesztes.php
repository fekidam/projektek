...
$tamogatoadat=tamogatoadat_leker($v_tamogatoid);
?>
<div id="be">
    <h1>Tamogato szerkesztese</h1>
<form method="POST" action="tamogatomodosit.php" accept-charset="utf-8">
    <label class="formlabel">Tamogatoid:</label>
    <?php
    echo '<input class="forminput" type="number" name="tamogatoid" value="'.$tamogatoadat['tamogatoid'].'">';
    ?><br>
    <label class="formlabel">Csapatid:</label>
    <?php
    echo '<input class="forminput" type="text" name="csapatid" value="'.$tamogatoadat['csapatid'].'">';
    ?>
    <br>
    <input class="forminput" type="submit"  value="Elkuld">
</form>
<form method="POST" action="tamogatotorol.php">
    <?php
    echo '<input type="hidden" name="tamogatoid" value="'.$v_tamogatoid.'">';
    ?>
